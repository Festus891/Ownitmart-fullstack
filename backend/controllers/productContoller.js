...
// get all products and search by keyword feature => /api/v1/product?keyword=apple
...
exports.getSingleProduct = catchAsyncErrors(async (req, res, next) => {
  ...
  if (!product) {
    // This commented out is before global errorHandler is created
    ...
    //This after global error has been created we use this below
...
exports.updateProduct = catchAsyncErrors(async (req, res, next) => {
  ...
  if (images !== undefined) {
    // Deleting images associated to the products
...
// THIS SECTION IS FOR USER REVIEW ON PRODUCTS
...
// Delete products reviews => /api/v1/reviews
